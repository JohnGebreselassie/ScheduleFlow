...
class Runtime(object):
    ...
    def __call__(self, sch):
        ...
        while not self.__events.empty():
            ...
            self.scheduler.system.update_time(self.__current_time)
...
class VizualizationEngine(): #gif animation
    ...
    def __init__(self, procs, execution_log=[], horizontal_ax_limit=0,
        ...
        self.__scaley = 150 / procs #changed to 75 for vibes, was originally 150
